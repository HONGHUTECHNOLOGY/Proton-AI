# 质子AI (Proton-AI)
## 质子AI官网：https://protonai.pages.dev
## 质子AI网页端：https://protonchat.pages.dev
---
### 质子AI是由鸿鹄科技开发的综合AI大模型，利用AI智能判断问题类型选择合适的大模型回答，同时实现了多模态能力。质子AI已更新至V4版本，全新上线深度研究和深度搜索模式，可以进行长时间的多轮思考并进行网页搜索，并制作长篇研究报告。同时质子AI接入质子知识库，心理辅导能力遥遥领先！V4版本接入了新版DeepSeek V3和R1提供强大代码能力及文本创作能力，并且上线了高德地图MCP服务，实现了天气查询，路线规划，旅游规划，店铺推荐等功能。
---
## 智能AI路由
...
## 深度研究和深度搜索
质子AI-V4全新上线深度研究模式，通过长时间的多轮思考并进行百科和网页搜索，根据每一轮搜索到的内容边思考边搜索，给出长篇研究报告。并将V3版本的深度搜索升级到深度研究相同的技术栈，同样可以进行长时间思考搜索。
```mermaid
flowchart TD
    A[用户输入] --> B{问题分析}
    B --> C[确定Wiki搜索内容]
...
---
## Prompt优化
质子AI独家Prompt优化，模型回答更人性化，更有活力，更有逻辑。质子提示词使DeepSeek-V3充分发挥出其文学实力，作为文学模型比官方V3模型写作水平更高。
---
目前接入的大模型及服务：
| 模型名称                          | 主要职责                               |
|-----------------------------------|----------------------------------------|
| DeepSeek-R1                       | 推理和数学问题分析                      |
| DeepSeek-V3                       | 代码编写，外语翻译，文学创作，助力高德MCP服务          |
| Kolors                            | 图像生成                               |
| Cogview-3-Flash                   | 图像生成                               |
| CogviewX-Flash                   | 视频生成                               |
| GLM-4-Flash                     | 模型选择                             |
| GLM-4V-Flash                      | 图像识别                               |
| GLM-Z1-Flash                      | 知识问答(命中知识库)                      |
| BGE-m3                            | 知识库检索的向量模型                    |
| Gemini-2.0-Flash-Lite             | 心理知识库检索问题优化                  |
| Gemini-2.0-Flash                  | 心理辅导和聊天                         |
| Gemini-2.5-Flash                  | 深度研究长篇报告编写                 |
| SenseVoiceSmall                   | 语音识别                     |
| Qwen3-235B-A22B                   | 古诗创作，古文解析                    |
